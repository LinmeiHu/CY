...
`STOP_INTEGRITY_REVIEW_REQUIRED`.
...
Human review must first decide whether to audit/reconstruct Phase 7 provenance or
abandon the consumed-sample candidate branch. Any rerun requires a new experiment
ID and fresh isolated output paths; EXP-P7-003 must never be silently repaired or
overwritten. The preferred research continuation is future prospective validation,
not another 2018-2025 threshold or interaction search.

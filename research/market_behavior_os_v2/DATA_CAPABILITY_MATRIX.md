...
| Cross-day objective support/resistance | CY-006 causal action chain + QD-004/CY-008 raw minute path | COORDINATE PASS; REPRESENTATION NOT YET ESTABLISHED | MKT-SUPPORT-DATA-003 passes exact source-role mapping on 1,225 sessions and 30 actions; close disagreements remain explicit. A later map must establish test/penetration/recovery/repeated-test representation before any support claim |

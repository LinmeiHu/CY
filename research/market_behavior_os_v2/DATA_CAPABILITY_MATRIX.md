...
| Cross-day objective support/resistance | CY-006 causal action chain + QD-004/CY-008 raw minute path | SUPPORT: TWO ROLLING-LEVEL COORDINATES, PROCESS/UNCHANGED-LEVEL FAIL; RESISTANCE: FULL-MARKET FORMATION DOMAIN PASS, L40 CHINEXT ACCEPTANCE-INDUSTRY DOMAIN FAIL | Support direction/residual coupling fail and only 7 sequences retain one exact L20. Full-market breakout formation has 538,891 L20 events and exact coordinates; L40 ChiNext acceptance-industry coverage misses 0.85, and no representation/process/usefulness is yet established |

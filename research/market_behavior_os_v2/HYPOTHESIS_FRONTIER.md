...
MKT-DSTRESS-001 rejects the exact directional weakest-link and recurring-process
architecture. The active queue moves to MKT-MIN-PATH-001 because exact
required-scale non-slope shapes already exist and address a distinct aggregation
gap without another raw-minute scan. Endpoint/OLS3 neighbors may not rescue OLS5,
and no favorable descriptor may be selected after looking at outcomes.

MKT-MIN-PATH-002 subsequently freezes only minute-realized-volatility ordinal
progression. The active queue first tests its outcome-blind redundancy against
...
MKT-VOL-TRANS-001 is frozen under spec `21145136...`. Its t+25 response removes
return-interval overlap; baseline dynamics and causal-PIT direction/discovery
modifiers have separate fixed gates and reused-time labels. No strategy habitat
or return interpretation is permitted.

MKT-VOL-TRANS-001 is invalid before accepted estimation because one direction-
PIT cell misses the unchanged support gate. MKT-VOL-TRANS-002 retains every
...
MKT-MIN-SUPACC-001 is frozen under spec `fcdc9d35...`. Three four-component
...
MKT-STYLE-001 retains six minimal roles. One-day return spread compresses into

...
| Size/style | size structure, participation, leadership, diffusion, concentration, divergence, transition | Five direct circulating-size coordinates; structure compresses, leadership level unstable, and exact transition self-process fails | PARTIAL_REPRESENTATION_SUPPORT_SELF_PROCESS_FAIL | One fixed participation-breadth precursor edge, then diversify without horizon rescue |

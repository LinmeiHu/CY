...
| Support/resistance | objective levels, tests, penetration, recovery, decay | Same-session VWAP defense is distinct but has no self-dynamic; cross-day objective levels unrepresented | FAMILY_UNDEREXPLORED_ACTIVE_DATA_CONTRACT | Establish PIT/action coordinate for prior levels and minute tests before representation |

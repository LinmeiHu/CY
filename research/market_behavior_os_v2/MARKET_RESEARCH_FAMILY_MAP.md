...
| Leadership/rotation | concentration, persistence, diffusion, failure, industry migration | MKT-INDRS-001 freezes equal-industry participation/dispersion, winner diffusion, rank rotation, and three leave-one-out stock/industry residual roles; exact industry depth/concentration/persistence roles fail or compress | PARTIAL_REPRESENTATION_SUPPORT_ACTIVE | Role-specific geometry against the accepted engine, then temporal meaning if distinct |

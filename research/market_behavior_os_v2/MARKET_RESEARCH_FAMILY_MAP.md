...
| Leadership/rotation | concentration, persistence, diffusion, failure, industry migration | Stock leadership concentration/imbalance levels stable; exact stock-level transition definitions fail; industry state not deeply mapped | FAMILY_UNDEREXPLORED_ACTIVE | Industry leadership/rotation/relative-strength map without MA20 clones |

...
| Size/style | size structure, participation, leadership, diffusion, concentration, divergence, transition | Five direct circulating-size coordinates; structure is external activity/risk ordering and 10/20/40 leadership level unstable | PARTIAL_REPRESENTATION_SUPPORT_TEMPORAL_MEANING_UNTESTED | Nonoverlapping leadership-transition process before any size-premium or archetype claim |

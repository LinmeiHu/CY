...
| winner-industry diffusion x rank rotation temporal graph | broad distribution of stock winners x cross-industry leadership migration | FROZEN_DIRECTED_EDGE_TEST_PENDING | MKT-INDRS-DYN-001 spec `b1266eed...` fixes three individual next-state edges and controls. No A+B synergy or strategy claim is permitted unless individual edges replicate and a later combination is separately frozen. |

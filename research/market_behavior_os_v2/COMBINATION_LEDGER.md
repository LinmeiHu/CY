...
| winner-industry diffusion x rank rotation temporal graph | broad distribution of stock winners x cross-industry leadership migration | WAIT_TEMPORAL_MAP | Only outcome-blind next-state edges may be tested first. No A+B synergy or strategy claim is permitted unless individual temporal edges replicate and a later combination is separately frozen. |

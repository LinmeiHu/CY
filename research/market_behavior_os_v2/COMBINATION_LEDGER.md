...
| immediate rotation persistence x delayed/alternate-definition falsification | adjacent Spearman self-edge x non-shared-endpoint Spearman/Kendall/displacement replication | FROZEN_CONSUMED_EXPLORATORY_FALSIFICATION | Three all-required replications are frozen before response construction. Both blocks are already consumed; passing cannot become confirmation or a strategy claim. |

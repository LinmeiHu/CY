...
| industry/relative-strength roles x accepted market-state controls | seven provisional industry coordinates x role-specific direction/breadth/correlation/liquidity/volatility/leadership controls | FROZEN_EXACT_SEMANTIC_RETRY_PENDING | MKT-INDRS-GEO-002 control `7b91844c...` inherits the fixed roles/controls/gates and corrects only nested causal-control year eligibility. This is latent-mechanism compression, not synergy or a rule. |

...
- This is post-hoc development anatomy generated by V1.1's surprising adverse
  sign. It is not confirmation, OOS evidence, or a strategy experiment.
- Q1 absolute mean is -0.002%/-0.165%/-0.493% at h5/h10/h20; median is
  -0.752%/-1.580%/-2.705%, win rate 45.30%/43.06%/41.84%, and only 9/3/1 of 18
  cells are positive.
- Q1 industry-relative positivity is 14/13/8 cells, but both-coordinate
  positivity is only 8/2/0. There is no standalone or relative reversal family.
- Q1 strength contributes 7.88%/11.56%/5.72% of the primary spread. Q5 weakness
  carries the rest, so the anatomy is avoidance-like rather than long-Alpha.
- Only 0/3/1 cells have broadly monotonic Q1--Q5 degradation. Continuous
  recovery rho is negative in 108/108 primary coordinates but economically
  small; Further Drawdown is positive in 96/108 and likewise small.
- The frozen early/late gate triggers at two primary horizons; annual economics
  are mixed. No severity cell and only 1/3 of each coarse-control tercile pass.
- Final classification: `CHRONOLOGICALLY_UNSTABLE`. Status:
  `POST_HOC_DEVELOPMENT_ANATOMY_NO_CANDIDATE_NOT_CONFIRMED_ALPHA`.
...
Has any discovered mechanism implied a genuinely new strategy archetype? No.
The reversed surface is informative as adverse-recovery anatomy, but Q1 does
not earn a long-reversal hypothesis and Q5 avoidance is not translated here.

...
- Eligible symbols: 3,373
- Strict gap primitives: 448,483
- Provisional grouped episodes/stacks: 145,888
- Broad collapse episodes (decline at least 20% retrieval rule): 84,368
- Multi-primitive broad collapse episodes: 52,166
- Main/ChiNext review-eligible candidates: 92,585/29,202
- ST/non-ST candidates: 3,305/118,482

These thresholds are retrieval rules, not economic findings.

## Blind sample

- Charts: 120 (72 Main, 48 ChiNext)
- Machine-positive / immediate-fast / hidden near-miss: 80 / 20 / 20
- ST cases: 21; multilayer cases: 73; same-day cases: 14
- Identity leaks: 0; post-reentry chart data: 0; outcome-selected rows: 0

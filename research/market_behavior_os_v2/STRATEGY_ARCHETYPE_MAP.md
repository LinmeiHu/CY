...
| Industry rotation | leadership migrates with breadth/diffusion confirmation | relative transition trigger; leadership failure exit | rank rotation and winner diffusion remain externally distinct; top-set persistence fails and temporal process/usefulness is untested | SEARCH_SPACE |

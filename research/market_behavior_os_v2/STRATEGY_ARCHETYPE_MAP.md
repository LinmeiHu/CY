...
| Industry rotation | leadership migrates with breadth/diffusion confirmation | relative transition trigger; leadership failure exit | rank rotation and winner diffusion representations freeze; top-set persistence fails and no future process/usefulness exists | SEARCH_SPACE |

...
| MARKET HABITAT HYPOTHESIS | Frozen direction/discovery describe denser opportunity formation without payoff synergy. Formation depth is a distinct broad downside state after five fixed market controls, but HAB-CHX-FORMDEPTH-001 finds no incremental V1 candidate/cycle habitat transfer. No complete habitat is established. |

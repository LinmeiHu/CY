...
|---|---:|---|---|
| EXPLORE | 10% | Corrected V3 zones traverse structurally but completed-close/next-minute entries fail the frozen T+5/T+10 monetizability gate | Close this standalone alpha lane; move to a genuinely independent mechanism and do not open Validation or select favorable strata |

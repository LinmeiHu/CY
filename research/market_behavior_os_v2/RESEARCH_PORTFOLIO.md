...
|---|---:|---|---|
| EXPLORE | 20% | Corrected Pre-Break Suffocation V4 is descriptive-only: event weighting favors extreme dry-up, date-equal weighting reverses, Main same-date evidence conflicts with ChiNext, and fixed K20 combined allocation worsens | Close V4 without Validation or V5; do not rescue through neighboring volume windows, cutoffs, board rules, or V3 champions |
